...
{
$offer = 'https://gmboxx.com/get?cid=4782&cn='.$judul.'&pl='.$_SERVER['HTTP_HOST'].'';
}
else
{
$offer = 'http://look.kfiopkln.com/offer?prod=1&ref=5157448&m=books&q='.$eURI[2].'&sub_id='.$_SERVER['HTTP_HOST'].'';
}
