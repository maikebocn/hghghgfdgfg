...
{
$offer = 'http://look.kfiopkln.com/offer?prod=1&ref=5157126&m=books&q='.$eURI[2].'&sub_id='.$_SERVER['HTTP_HOST'].'';
}
else
{
$offer = 'http://look.kfiopkln.com/offer?prod=1&ref=5157122&m=books&q='.$eURI[2].'&sub_id='.$_SERVER['HTTP_HOST'].'';
}
